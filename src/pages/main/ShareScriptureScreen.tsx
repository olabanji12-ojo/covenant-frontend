...
export const ShareScriptureScreen = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f7f5f0] w-full max-w-sm md:max-w-2xl mx-auto overflow-hidden md:pb-6 md:bg-white md:shadow-sm md:border-x border-gray-100">
