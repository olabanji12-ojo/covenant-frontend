...
export const PrayerScreen = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f7f5f0] w-full max-w-sm md:max-w-4xl mx-auto relative overflow-hidden pb-28 md:pb-6 md:bg-white md:shadow-sm md:border-x border-gray-100">
